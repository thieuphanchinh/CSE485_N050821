...
<div class="modal fade" id="myModal">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
    <input id="email" name="email" autocomplete="new-password" placeholder="Nhập email của bạn" class="form-control input-md" type="email">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input id="password" name="password" autocomplete="new-password" placeholder="Nhập mật khẩu" class="form-control input-md" type="password">
